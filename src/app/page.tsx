        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              {/* Descripción obligatoria para cambio: qué quiere cambiar el cliente */}
              {claimType === "cambio" && (
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    ¿Qué cambio querés hacer? <span className="text-red-600">*</span>
                  </label>
                  <textarea
                    required
                    value={description}
                    ...
                    rows={4}
                    className="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none text-gray-900"
                    placeholder="Ej: Quiero cambiar la talle M por talle L, o quiero cambiar por otro modelo (especificá cuál)..."
                  />
                  <p className="text-xs text-gray-500">
                    Detallá bien el cambio (talle, color, producto, etc.) para que podamos prepararlo.
                  </p>
                </div>
              )}
