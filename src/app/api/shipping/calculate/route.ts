...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Para reenvío (includeFree=true) dejamos pasar los $0 también; la UI los filtra
    // con reenvioCarrierPrice (que cae a shipping_cost_owner solo si el carrier matchea
    // el original, sino los oculta).
